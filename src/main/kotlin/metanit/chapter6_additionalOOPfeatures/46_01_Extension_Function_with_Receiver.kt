 ...
 *
 *   Вообще ключевой момент происходит именно на `Peson.() -> Unit`, именно этот параметр (лямбда)
 *   вроде как и является функцией расширения с получателем... Внутри тела этой лямбды можно напрямую
 *   обращаться к свойствам и методам объекта Person без ключевого слова this
 * */
