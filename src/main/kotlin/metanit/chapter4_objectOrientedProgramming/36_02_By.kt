 ...
 * Зачем?
 *
 *    - Избегаем наследования. Смартфон - не разновидность мессенджера. Он имеет мессенджер.
 *
 *    - Принцип композиции.
 *
 *    - Гибкость. Можно легко подменять делегата. Добавлять свою логику к отдельным методам интерфейса.
 *
 *ВАЖНО:
 *
 *     - Делегирование работает только с интерфейсами (или абстрактными классамм, у которых все
 *             абстрактные методы). Нельзя делегировать обычному классу.
 * */